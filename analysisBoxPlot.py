...
def render_box_plot(col):
    ...
    selected_col = col.selectbox("Select feature", imputed_columns, key="feature_select_box_box_plot")
    ...
    sns.boxplot(x="Stage", y="Value", data=comparison, palette=['skyblue', 'salmon', 'lightgreen'], ax=ax)

    ax.set_ylabel(selected_col)
    ax.set_title(f"Box Plot: Original vs Imputed vs Total Values for '{selected_col}'")
